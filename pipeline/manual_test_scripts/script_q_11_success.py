...
QUESTION    : Số dư tiền gửi tại các TCTD khác cuối năm 2016 của Ngân hàng TMCP Đầu tư và Phát triển Việt Nam (BID) là bao nhiêu triệu đồng?
RESULT      : {"type": "scalar", "data": 44293700.0}
ERROR       : None
======================================================================
"""
...
search_key = 'tiền gửi tại các TCTD khác cuối    Ngân hàng TMCP Đầu tư và Phát triển Việt Nam ()  triệu đồng?'
