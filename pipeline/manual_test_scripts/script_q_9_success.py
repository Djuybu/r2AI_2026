...
QUESTION    : Chi phí khác của SAM năm 2023 là bao nhiêu triệu đồng?
RESULT      : {"type": "scalar", "data": 14770703601.0}
ERROR       : None
======================================================================
"""
...
search_key = 'Chi phí khác      triệu đồng?'
...
if mask.any():
    ...
    result = extract_value(match_row, 'Năm 2023', _df=df, _row_idx=match_row.name)
else:
    match_row = df.iloc[0]
    result = extract_value(match_row, 'Năm 2023', _df=df, _row_idx=match_row.name)