import os, sys, unicodedata, re, time
import pandas as pd
import numpy as np
        ...
        if p_res and p_res.exists():
            try:
                ...
                if not df.empty:
                    ...
                    # Extract Ten_Bang from dataframe or doc
                    tb_name = ""
...
if __name__ == "__main__":
    ...
    print("STARTING EVALUATION ACROSS ALL 11 GROUP 2 TEST CASES...\n", flush=True)
